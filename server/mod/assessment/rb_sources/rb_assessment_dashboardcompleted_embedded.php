...
class rb_assessment_dashboardcompleted_embedded extends rb_base_embedded
{
    ...
    public function __construct($data)
    {
        ...
        $this->url = '/mod/assessment/dashboard.php?type=completed';
        $this->source = 'assessment_dashboard';
        $this->shortname = 'assessment_dashboardcompleted';
        $this->fullname = get_string('dashboardcompleted', $this->plugin);
        $this->columns = [
        ...
        if (!has_capability('mod/assessment:viewcompleteddashboard', context_system::instance())) {
    ...
    {
        return has_capability('mod/assessment:viewcompleteddashboard', context_system::instance())
