...
class rb_assessment_dashboardfailed_embedded extends rb_base_embedded
{
    ...
    public function __construct($data)
    {
        ...
        $this->url = '/mod/assessment/dashboard.php?type=failed';
        $this->source = 'assessment_dashboard';
        $this->shortname = 'assessment_dashboardfailed';
        $this->fullname = get_string('dashboardfailed', $this->plugin);
        $this->columns = [
        ...
        $this->embeddedparams = [];
        $this->embeddedparams['needsreview'] = 1;
        $this->embeddedparams['attemptfailed'] = 1; // Filter by this status.
        ...
        if (!has_capability('mod/assessment:viewfaileddashboard', context_system::instance())) {
    ...
    {
        return has_capability('mod/assessment:viewfaileddashboard', context_system::instance())
