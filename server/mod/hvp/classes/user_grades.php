...
class user_grades {
    ...
    public static function handle_ajax() {
        ...
        $xapi = $DB->get_record('hvp_xapi_results', array('content_id' => $hvp->id, 'user_id' => $USER->id));
        $xapi->raw_score = $score;
        $xapi->max_score = $maxscore;
        $DB->update_record('hvp_xapi_results', $xapi);
