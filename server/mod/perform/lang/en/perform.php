...
$string['activation_criteria_relationships'] = 'At least one responding participant relationship added per section';
...
$string['subject_instance_card_instance_count'] = 'Instance number';
