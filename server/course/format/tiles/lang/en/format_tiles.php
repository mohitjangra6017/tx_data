...
$string['allowphototiles_desc'] = 'If selected, course administrator will be able to upload a photo to serve as a tile background.  They will still be able to use standard tile icons as well, in the same course. (If not selected, only tile icons will be allowed and other photo tile settings below will be ignored.)';
...
$string['colourblue'] = 'Brand Grey Colour Three';
...
$string['completion'] = 'Your progress';
...
$string['followthemecolour_desc'] = 'If enabled, course administrators will not be given a choice by this plugin and all tile colours below will be ignored. Instead the tiles will use neutral grey.';
$string['followthemecolour'] = 'Prevent course-level configuration';
