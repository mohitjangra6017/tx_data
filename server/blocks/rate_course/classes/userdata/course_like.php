...
class course_like extends item {

    /**
     * @return array|string[]
     */
    public static function get_fullname_string() {
        return ['userdataitem-user-course_like', 'block_rate_course'];
    }
    ...
    protected static function count(target_user $user, context $context) {
        return builder::table('rate_course_course_likes')
    ...
    protected static function export(target_user $user, context $context) {
        $export = new export();
        $export->data =
            builder::table('rate_course_course_likes')
                   ->where('userid', '=', $user->id)
                   ->get()
                   ->all();
