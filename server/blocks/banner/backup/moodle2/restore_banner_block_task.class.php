<?php
/**
 * Specialised restore task for the banner block
 * (requires encode_content_links in some configdata attrs)
 *
 * TODO: Finish phpdocs
 */
class restore_banner_block_task extends restore_block_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_banner_block_decode_content('block_instances', 'configdata', 'block_instance');
 ...
 */
class restore_banner_block_decode_content extends restore_decode_content {
