...
class DashboardRegionMainTwoBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/dashboard_region_main_two_background_image';
    }
    ...
    {
        return 'dashboard_region_main_two_background_image';
    }
