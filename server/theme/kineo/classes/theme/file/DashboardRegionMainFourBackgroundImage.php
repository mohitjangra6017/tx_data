...
class DashboardRegionMainFourBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/dashboard_region_main_four_background_image';
    }
    ...
    {
        return 'dashboard_region_main_four_background_image';
    }
