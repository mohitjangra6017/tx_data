...
class CourseRegionPageBottomBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/course_region_page_bottom_background_image';
    }
    ...
    {
        return 'course_region_page_bottom_background_image';
    }
