...
class FrontpageRegionMainFourBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/frontpage_region_main_four_background_image';
    }
    ...
    {
        return 'frontpage_region_main_four_background_image';
    }
