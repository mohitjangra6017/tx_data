...
class LoginPageContentBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/login_page_content_background_image';
    }
    ...
    {
        return 'login_page_content_background_image';
    }
