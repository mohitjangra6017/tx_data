...
class CourseRegionPageTopBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/course_region_page_top_background_image';
    }
    ...
    {
        return 'course_region_page_top_background_image';
    }
