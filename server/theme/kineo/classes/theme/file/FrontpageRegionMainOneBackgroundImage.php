...
class FrontpageRegionMainOneBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/frontpage_region_main_one_background_image';
    }
    ...
    {
        return 'frontpage_region_main_one_background_image';
    }
