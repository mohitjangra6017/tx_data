...
class DashboardRegionPageTopBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/dashboard_region_page_top_background_image';
    }
    ...
    {
        return 'dashboard_region_page_top_background_image';
    }
