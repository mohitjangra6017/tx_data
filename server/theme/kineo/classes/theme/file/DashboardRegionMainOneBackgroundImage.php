...
class DashboardRegionMainOneBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/dashboard_region_main_one_background_image';
    }
    ...
    {
        return 'dashboard_region_main_one_background_image';
    }
