...
class CoursePageRegionBottomBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/course_page_region_bottom_background_image';
    }
    ...
    {
        return 'course_page_region_bottom_background_image';
    }
