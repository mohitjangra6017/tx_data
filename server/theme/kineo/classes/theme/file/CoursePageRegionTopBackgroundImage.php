...
class CoursePageRegionTopBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/course_page_region_top_background_image';
    }
    ...
    {
        return 'course_page_region_top_background_image';
    }
