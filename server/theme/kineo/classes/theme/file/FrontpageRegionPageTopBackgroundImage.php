...
class FrontpageRegionPageTopBackgroundImage extends theme_file
{
    /**
    ...
    {
        return 'theme_kineo/frontpage_region_page_top_background_image';
    }
    ...
    {
        return 'frontpage_region_page_top_background_image';
    }
