...
<!-- Content -->
<?php echo $themerenderer->blocks('dash-pge-top'); ?>
    ...
    <div id="page-content">
        ...
        <div class="row">
            <div id="region-main" class="<?php echo $themerenderer->main_content_classes(); ?>">
                ...
                <article><?php echo $themerenderer->main_content(); ?></article>
                <?php echo $themerenderer->blocks('dash-main-one'); ?>
                <?php echo $themerenderer->blocks('dash-main-two'); ?>
                <?php echo $themerenderer->blocks('dash-main-three'); ?>
                <?php echo $themerenderer->blocks('dash-main-four'); ?>
...
<?php echo $themerenderer->blocks('dash-pge-bottom'); ?>
<!-- Footer -->
