...
<!-- Content -->
<?php echo $themerenderer->blocks('front-pge-top'); ?>
    ...
    <div id="page-content">
        ...
        <div class="row">
            <div id="region-main" class="<?php echo $themerenderer->main_content_classes(); ?>">
                ...
                <?php echo $themerenderer->blocks('main-one'); ?>
                <?php echo $themerenderer->blocks('main-two'); ?>
                <?php echo $themerenderer->blocks('main-three'); ?>
                <?php echo $themerenderer->blocks('main-four'); ?>
...
<?php echo $themerenderer->blocks('front-pge-bottom'); ?>
<!-- Footer -->
