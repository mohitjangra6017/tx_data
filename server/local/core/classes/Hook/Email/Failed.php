...
class Failed extends base
{
     ...
     * @return Failed
     */
    public function setUserTo(stdClass $userTo): Failed
    {
        $this->userTo = $userTo;
        return $this;
    }
     ...
     * @return Failed
     */
    public function setUserFrom(stdClass $userFrom): Failed
    {
        $this->userFrom = $userFrom;
        return $this;
    }
     ...
     * @return Failed
     */
    public function setMailer(moodle_phpmailer $mailer): Failed
    {
        $this->mailer = $mailer;
        return $this;
    }
