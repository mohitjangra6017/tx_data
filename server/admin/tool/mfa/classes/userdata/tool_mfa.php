...
class tool_mfa extends item
{
    ...
    protected static function purge(target_user $user, context $context)
    {
        ...
        $records = $DB->get_records('tool_mfa', ['userid' => $user->id]);
        ...
        foreach ($records as $record) {
            $DB->delete_records('tool_mfa', ['id' => $record->id]);
        }
    ...
    protected static function count(target_user $user, context $context)
    {
        ...
        return $DB->count_records('tool_mfa', ['userid' => $user->id]);
    }
}