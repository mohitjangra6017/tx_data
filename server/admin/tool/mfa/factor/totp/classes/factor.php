...
class factor extends object_factor_base {
    ...
    public function generate_totp_uri($secret) {
        ...
        $issuer = str_replace(':', '', $SITE->fullname).' '.$domain;
    ...
    public function setup_factor_form_definition_after_data($mform) {
        ...
        // We allow XSS here because otherwise the QR code does not display.
        $static = new \MoodleQuickForm_static('description', get_string('setupfactor:scan', 'factor_totp'), $html);
        $static->set_allow_xss(true);
