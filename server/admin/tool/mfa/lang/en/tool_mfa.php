...
$string['privacy:metadata:tool_mfa:label'] = 'label for factor instance, eg device';
...
$string['usersauthedinperiod'] = 'Users authenticated in period';
...
$string['tool_mfa'] = 'MFA User Factors';