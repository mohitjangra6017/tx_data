...
if ($ADMIN->fulltree) {
    ...
    // Enable the 'HR Import' flag (totarasync) to be set for new user accounts.
    $settings->add(new admin_setting_configcheckbox(
            'auth_saml2/totarasync',
            get_string('totarasync', 'auth_saml2'),
            get_string('totarasync_help', 'auth_saml2'),
            0));
