...
// Strings for enabling totara sync on user account creation
$string['totarasync'] = 'Allow HR Import updates';
$string['totarasync_help'] = 'Ticks the "HR Import?" profile field on user creation';
