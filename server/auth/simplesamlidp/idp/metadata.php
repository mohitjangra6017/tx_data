 ...
 * way so it has been copied here and forked.
 *
 * Original file is: extlib/simplesamlphp/www/saml2/idp/metadata.php
...
if ($download) {
    header('Content-Disposition: attachment; filename=' . $simplesamlidpauth->idpname . '.xml');
}

// load SimpleSAMLphp configuration and metadata
$config = \SimpleSAML\Configuration::getInstance();
$metadata = \auth_simplesamlidp\SimpleSAML\Metadata\SSPMetaDataStorageHandler::getMetadataHandler();
...
try {
    ...
    if ($idpmeta->getBoolean('saml20.sendartifact', false)) {
        ...
        $metaArray['ArtifactResolutionService'][] = [
            'index'    => 0,
            'Location' => HTTP::getBaseURL().'ArtifactResolutionService.php',
    ...
    if ($idpmeta->getBoolean('saml20.hok.assertion', false)) {
        ...
        array_unshift($metaArray['SingleSignOnService'], [
            ...
            'Location'               => HTTP::getBaseURL().'SSOService.php'
        ]);
    }
