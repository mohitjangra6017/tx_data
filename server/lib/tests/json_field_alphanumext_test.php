...
use core\json\schema\field\field_alphanumext;
use core_phpunit\testcase;

class core_json_field_alphanumext_testcase extends testcase {
    /**
     * @return void
     */
    public function test_validate_value(): void {
        $field = new field_alphanumext('name');
        self::assertEquals(
        ...
        self::assertNull($field->validate('abcde_-eee15'));
    ...
    public function test_clean_value(): void {
        ...
        self::assertEquals('zxc_-c1', $field->clean('zxc_-c1'));
