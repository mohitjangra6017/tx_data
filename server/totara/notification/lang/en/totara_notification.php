...
$string['disable_all_helptext'] = 'Disable all notifications, including locked and custom notifications.';
...
$string['enable_custom_locked_delivery_Channels'] = 'Enable customising locked delivery channels';
...
$string['error_cannot_delete_custom_notification'] = "Cannot delete the custom notification";
...
$string['event_update_custom_notification_preference'] = 'Update custom notification prerference';
$string['invalid_input'] = 'Invalid value';
$string['locked'] = 'Locked';
$string['locked_delivery_help'] = 'This setting forces delivery of important notifications through selected channels, regardless of user preferences';
$string['locked_info'] = 'Locked delivery information';
$string['lock_channel_x'] = 'Lock channel {$a}';
