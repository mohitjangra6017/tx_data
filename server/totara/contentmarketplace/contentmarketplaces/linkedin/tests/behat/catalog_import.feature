...
Feature: Use the catalogue import page to create courses based upon LinkedIn Learning course content.
  ...
  Scenario: Learning objects catalog: Card content
    # TODO: In TL-30372, make sure we cover subjects/classifications
    Given the following "learning objects" exist in "contentmarketplace_linkedin" plugin:
    ...
    # Course A
    And I should see "Coming soon" on row "1" of the tui select table
    ...
    # Course B
    And I should see "Coming soon" on row "2" of the tui select table
    ...
    # Course C
    And I should see "Coming soon" on row "3" of the tui select table
  ...
  # TODO: In TL-30372, make sure we cover subjects/classifications filter tree
  ...
  Scenario: Learning objects catalog: Create courses from basket selection with categories
    ...
    And I should see "Course A" in the ".tw-catalog .tw-grid__item:nth-child(1)" "css_element"
    And I should see "Category B" in the ".tw-catalog .tw-grid__item:nth-child(1)" "css_element"
    And I should see "Course B" in the ".tw-catalog .tw-grid__item:nth-child(2)" "css_element"
    And I should see "Category C" in the ".tw-catalog .tw-grid__item:nth-child(2)" "css_element"
    ...
    # TODO: In TL-31176, make sure we cover that they now say "Appears in 1 courses"
