...
class contentmarketplace_goone_course_module_source_testcase extends testcase {
    ...
    public function test_upgrade_with_data(): void {
        ...
        $go1_id1 = '12345678';
        $module_1 = $this->create_goone_course_module('A', $go1_id1, __DIR__ . '/fixtures/scorm/course1.zip');

        $go1_id2 = '87654321';
        $module_2 = $this->create_goone_course_module('B', $go1_id2, __DIR__ . '/fixtures/scorm/course2.zip');

        // Uses same learning object ID as course 1, to test how multiple courses using the same learning object functions.
        $module_3 = $this->create_goone_course_module('C', $go1_id1, __DIR__ . '/fixtures/scorm/course1.zip');
     ...
     * @param int $go1_id
     * @param string $scorm_zip_path
     * @return object Course module record
     */
    private function create_goone_course_module(string $course_name, int $go1_id, string $scorm_zip_path): object {
        global $CFG, $USER;
