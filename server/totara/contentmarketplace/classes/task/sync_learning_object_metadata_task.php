...
/**
 * Synchronise learning object metadata from the API into a local table.
 */
class sync_learning_object_metadata_task extends scheduled_task {
    /**
     * @inheritDoc
     */
    ...
    public function execute() {
        (learning_object_factory::create())->sync();
    }
}