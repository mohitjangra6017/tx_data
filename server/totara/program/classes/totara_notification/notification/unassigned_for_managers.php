...
final class unassigned_for_managers extends built_in_notification {
    ...
    public static function get_title(): string {
        return get_string('notification_unassigned_for_managers_title', 'totara_program');
    }
    ...
    public static function get_default_body(): lang_string {
        return new lang_string('notification_unassigned_for_managers_body', 'totara_program');
    }
    ...
    public static function get_default_subject(): lang_string {
        return new lang_string('notification_unassigned_for_managers_subject', 'totara_program');
    }
