...
$string['notification_comment_created'] = 'New comment created';
$string['notification_comment_created_body'] = 'A new comment created on your item';
$string['notification_comment_soft_deleted_body'] = 'Your comment has been deleted';
$string['notification_comment_soft_deleted'] = 'Comment deleted';
$string['owner'] = 'Owner';
$string['post'] = "Post";
