...
$supportedmods = \enrol_autoenrol\helper::get_mods_with_viewed_event();
foreach ($supportedmods as $modname) {
    $observers[] = [
        'eventname' => '\mod_' . $modname . '\event\course_module_viewed',
        'callback' => '\enrol_autoenrol\observer::course_module_viewed',
    ];
}

$observers[] = [
    'eventname' => '\core\event\user_loggedin',
    'callback' => '\enrol_autoenrol\observer::user_loggedin',
];
