...
class enrol_autoenrol_plugin extends enrol_plugin {
    ...
    public const ENROL_AUTO_COURSE_VIEWED = 1;
    public const ENROL_AUTO_MOD_VIEWED = 2;
    public const ENROL_AUTO_LOGIN = 3;
    ...
    public function try_autoenrol(stdClass $instance, bool $preventredirect = true) {
        ...
        if ($instance->customint2 != self::ENROL_AUTO_COURSE_VIEWED) {
            return false;
        }
    ...
    public function add_default_instance($course)
    {
        $fields = [
            'status' => 0,
            'customint3' => $this->get_config('defaultrole'),
            'customint5' => 0,
            'customint8' => 0
        ];
    ...
    public function get_instance_defaults() {
        ...
        $fields['customint2'] = $this->get_config('enrolon');
    ...
    public function get_instance_for_course($courseid, $onlyenabled=true) {
        global $DB;
        $params = array('enrol' => 'autoenrol', 'courseid' => $courseid);
