...
class __Mustache_0c0644425cf6ed3b9309976cbbabed90 extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->find('xofy'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</span>
';
        $buffer .= $indent . '</small>
...
';
        ...
        $buffer .= $this->sectionD0c91d3e67049efab71e0fc1df416dfc($context, $indent, $value);
...
';
    ...
    private function sectionD0c91d3e67049efab71e0fc1df416dfc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
