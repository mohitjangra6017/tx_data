...
class __Mustache_0f1a942c9c32d89e4200c4bab29375fa extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="alert alert-danger alert-with-icon ';
        // 'closebutton' section
...
';
        ...
        $buffer .= $this->section60d522c397846f3659257888b9e5b3c7($context, $indent, $value);
        $buffer .= '</div>
';
...
';
    ...
    private function section60d522c397846f3659257888b9e5b3c7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'core|notification-error, , , ft-size-200';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'core|notification-error, , , ft-size-200';
                $context->pop();
            }
        }
