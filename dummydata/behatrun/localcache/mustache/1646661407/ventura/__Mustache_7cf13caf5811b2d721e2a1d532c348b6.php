...
class __Mustache_7cf13caf5811b2d721e2a1d532c348b6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'block789ec9f75fad7b219ca40fe28b18226b'),
                ...
                'headeractions' => array($this, 'blockB4fefd43729dc843c578e212904e0936'),
                'content' => array($this, 'block335c1f04356c27ed27cf861ab8585347'),
            ));
    ...
    private function section7140b1618cf6f384aa3524cc4f397fb3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'notification, togglenotificationmenu, message';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'notification, togglenotificationmenu, message';
                $context->pop();
            }
        }
    ...
    private function section69f2095a2ae9b401d4f66c6639d7abd6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' i/settings, core, notificationpreferences, message ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' i/settings, core, notificationpreferences, message ';
                $context->pop();
            }
        }
...
';
    ...
    public function block789ec9f75fad7b219ca40fe28b18226b($context)
    {
        $indent = $buffer = '';
        $buffer .= '        ';
        // 'flex_icon' section
        $value = $context->find('flex_icon');
        $buffer .= $this->section7140b1618cf6f384aa3524cc4f397fb3($context, $indent, $value);
        $buffer .= '
';
...
';
    ...
    public function blockB4fefd43729dc843c578e212904e0936($context)
    {
        $indent = $buffer = '';
...
';
        ...
        // 'pix' section
        $value = $context->find('pix');
        $buffer .= $this->section69f2095a2ae9b401d4f66c6639d7abd6($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '        </a>
';
    ...
    public function block335c1f04356c27ed27cf861ab8585347($context)
    {
        $indent = $buffer = '';
