...
class __Mustache_137ccdddf952bb5b1d8e014422244529 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section82916671c7ce737e9bbf1988a5001da4($context, $indent, $value);
        $buffer .= '</div>
';
...
';
    ...
    private function section82916671c7ce737e9bbf1988a5001da4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'core|notification-success, , , ft-size-200';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'core|notification-success, , , ft-size-200';
                $context->pop();
            }
        }
