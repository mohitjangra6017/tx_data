        ...
        <Table :data="tenants">
          ...
          <template v-slot:row="{ row }">
            ...
            <Cell>
              ...
              <a :href="backupLink(row.id)" target="_blank">
                <Download
                    :alt="$str('edittenantsetting', 'totara_tui', row.name)"
                />
              </a>
              <a :href="restoreLink(row.id)">
                <Add
                    :alt="$str('restore', 'core', row.name)"
                />
              </a>
            </Cell>
          </template>
...
import Download from 'tui/components/icons/Download';
...
export default {
  ...
  data() {
    return {
      configLink: this.$url('/theme/kineo/theme_settings.php', {
  ...
  methods: {
    tenantLink(tenant_id) {
      return this.$url('/theme/kineo/theme_settings.php', {
        theme_name: this.theme,
        tenant_id: tenant_id,
      });
    },
